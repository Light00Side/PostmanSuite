...
#[derive(Debug)]
pub struct PostmanSuiteProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PostmanSuiteProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PostmanSuite processing");
    
    let mut processor = PostmanSuiteProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PostmanSuiteProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PostmanSuiteProcessor::new(false);
